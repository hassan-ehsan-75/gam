...
@section('content')
    <div class="container-fluid">
        <div class="container col-md-5">
            <h1 class="text-center">تعديل بند</h1>
            ...
            <form method="POST" action="{{route('records.update',$record->id)}}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="text" required value="{{$record->text}}" />
                        @error('text')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea type="text" class="form-control" name="description" required>{{$record->description}}</textarea>
                        @error('description')
                        <p style="color: red;">{{$message}}</p>
                        @enderror
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select required class="form-control" name="gathering_id" >
                                @foreach($gatherings as $gath)
                                    <option @if($gath->id==$record->gathering_id) selected @endif value="{{$gath->id}}">{{$gath->g_number.'-'.\App\Models\Gathering::$g_type[$gath->type].'-'.$gath->g_date}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control"  value="{{$record->sort}}" disabled />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="radio" id="html" name="type" value="1" @if($record->type==1) checked @endif >
                                <label for="html">غير قابل للتصويت</label><br>
                            </div>
                            <div class="col-md-6">
                                <input type="radio" id="css" name="type" value="2" @if($record->type==2) checked @endif>
                                <label for="css">قابل للتصويت</label><br>
                            </div>
                            <div class="col-md-6">
                                <input type="radio" id="css" name="type" value="3" @if($record->type==3) checked @endif>
